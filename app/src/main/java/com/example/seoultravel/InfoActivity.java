...
public class InfoActivity extends AppCompatActivity
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_exit) {
            AlertDialog.Builder alert_confirm = new AlertDialog.Builder(InfoActivity.this);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_local) {
            ...
            startActivity(new Intent(InfoActivity.this, LocalActivity.class));
            finish();
        } else if (id == R.id.nav_hit) {
            return true;
        } else if (id == R.id.nav_thema) {
            startActivity(new Intent(InfoActivity.this, ThemaActivity.class));
            finish();
