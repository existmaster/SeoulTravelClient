...
public class ThemaActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setCheckedItem(R.id.nav_thema);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_exit) {
            AlertDialog.Builder alert_confirm = new AlertDialog.Builder(ThemaActivity.this);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_local) {
            ...
            startActivity(new Intent(ThemaActivity.this, LocalActivity.class));
            finish();
        } else if (id == R.id.nav_hit) {
            startActivity(new Intent(ThemaActivity.this, HitActivity.class));
            finish();
        } else if (id == R.id.nav_thema) {
            return true;
        } else if (id == R.id.nav_info) {
            startActivity(new Intent(ThemaActivity.this, InfoActivity.class));
            finish();
        }
